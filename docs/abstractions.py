...
This file will take you on a whirlwind journey from a Tensor all the way down to
tinygrad which has been aggressively refactored in the 2.5 years it's been worked on.
...
this documentation will help you with entry points and understanding the abstraction stack.
"""
...
class Tensor:
  ...
  # High-level ops (hlops) are defined in this class. example: relu
...
# Ffter some formatting (the compiler doesn't care)
